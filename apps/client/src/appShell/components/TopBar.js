...
import { FlexMiddle, DropDown, FlexSpace, MenuBurger as BaseMenuBurger, Spinner } from 'shared/components';
...
const TopBar = ({ setIsOpen }) => {
	const { loading, projects, selectedProject, setSelectedProject } = projectStore();
