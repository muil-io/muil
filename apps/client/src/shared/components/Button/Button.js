...
const Button = styled.button`
	...
	&:hover {
		border: 1px solid ${({ theme, buttonType = 'primary' }) => theme.button[buttonType].hover.border};
	...
	&:disabled {
		cursor: no-drop;
		border: 1px solid ${({ theme, buttonType = 'primary' }) => theme.button[buttonType].disabled.border};
		background: ${({ theme, buttonType = 'primary' }) => theme.button[buttonType].disabled.background};
