	...
	return (
		<Wrapper>
			...
			<Container isVisible={activeTab === 'props'}>
				<DynamicProps dynamicProps={dynamicProps} onChange={setDynamicProps} baseTemplateUrl={baseTemplateUrl} />
			</Container>

			<Container isVisible={activeTab === 'api'}>
				<Api dynamicProps={dynamicProps} onChange={setDynamicProps} baseTemplateUrl={baseTemplateUrl} />
			</Container>
		</Wrapper>
	);
};
