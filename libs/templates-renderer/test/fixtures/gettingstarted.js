/*! For license information please see gettingstarted.js.LICENSE.txt */
(() => {
  'use strict';
  var A = {
      197(A, e) {
        ...
        function a(A, e, a) {
          var o = null;
          if ((void 0 !== a && (o = '' + a), void 0 !== e.key && (o = '' + e.key), 'key' in e))
            for (var C in ((a = {}), e)) 'key' !== C && (a[C] = e[C]);
          else a = e;
          return (
            (e = a.ref), { $$typeof: r, type: A, key: o, ref: void 0 !== e ? e : null, props: a }
          );
        }
        Symbol.for('react.fragment'), (e.jsx = a), (e.jsxs = a);
      },
      85(A, e, r) {
        A.exports = r(197);
      },
  ...
  function r(a) {
    ...
    var C = (e[a] = { exports: {} });
    return A[a](C, C.exports, r), C.exports;
  }
  (r.d = (A, e) => {
    for (var a in e)
      r.o(e, a) && !r.o(A, a) && Object.defineProperty(A, a, { enumerable: !0, get: e[a] });
  }),
  ...
  (C.displayName = 'Getting Started Template'), (C.dynamicProps = { name: 'John' });
  const n = C;
  module.exports = a;
})();
